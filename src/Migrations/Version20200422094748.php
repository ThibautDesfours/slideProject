 ...
 */
final class Version20200422094748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture DROP removed_at, CHANGE create_at create_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture ADD removed_at DATETIME DEFAULT \'NULL\', CHANGE create_at create_at DATETIME DEFAULT \'NULL\'');
